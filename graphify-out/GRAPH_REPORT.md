...
## Corpus Check
- 13 files · ~12,056,470 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2731 nodes · 5984 edges · 246 communities (110 shown, 136 thin omitted)
- Extraction: 95% EXTRACTED · 5% INFERRED · 0% AMBIGUOUS · INFERRED: 280 edges (avg confidence: 0.83)
...
1. `CameraRuntimeController` - 211 edges
2. `ControlReducer` - 130 edges
3. `AppState` - 128 edges
4. `CameraState` - 107 edges
5. `SafetyState` - 105 edges
6. `CameraCatalog` - 81 edges
7. `Reduction` - 65 edges
8. `DiveViewModel` - 57 edges
9. `CameraCommand` - 57 edges
10. `ControlCoreTest` - 57 edges
...
- `DiveViewModel` --references--> `AppState`  [EXTRACTED]
  app/src/main/kotlin/com/mobiledivecontrol/viewmodel/DiveViewModel.kt → core/src/main/kotlin/com/mobiledivecontrol/core/Contracts.kt
- `DiveViewModel` --references--> `PlatformEffect`  [EXTRACTED]
  app/src/main/kotlin/com/mobiledivecontrol/viewmodel/DiveViewModel.kt → core/src/main/kotlin/com/mobiledivecontrol/core/Contracts.kt
...
Cohesion: 0.05
Nodes (38): CameraCatalog, CameraModeProfile, CameraRailAction, Diagnostics, TrackHeading, CameraRailEntry, CameraSettingSpec, IntRange (+30 more)
...
Cohesion: 0.05
Nodes (77): BottomBarChip(), bottomBarIcon(), bottomBarLabel(), bottomBarValue(), BottomEditCard(), BottomSettingsTray(), BottomSettingsTrayLegacy(), CameraPreviewPlaceholder() (+69 more)

### Community 3 - "Core TransportOutcome"
Cohesion: 0.07
Nodes (31): AndroidBleTransport, BluetoothGatt, BluetoothGattCharacteristic, Boolean, ByteArray, Int, List, Long (+23 more)
...
### Community 7 - "Tests ControlCoreTest"
Cohesion: 0.07
...
Cohesion: 0.04
Nodes (42): AlertPriority, Critical, High, Low, Medium, CameraRailLevel, Primary, Secondary (+34 more)

### Community 11 - "Bluetooth AndroidBleTransport"
Cohesion: 0.08
Nodes (23): AwbCurvePoint, CameraRuntimeController, CaptureMetadataSnapshot, HarvestedWb, com, PointingGesture, WbAnchor, WbCalPoint (+15 more)

### Community 12 - "Gallery GalleryScreen.kt"
Cohesion: 0.09
Nodes (19): FocusPeakingSurfaceProcessor, FloatArray, SurfaceTexture, durationMs, positionMs, SurfaceTexture, Uri, LoopingVideoTextureView (+11 more)
...
Cohesion: 0.09
Nodes (7): SliderSensitivity, ControlReducer, ManualFocusPreparation, SliderLaw, Continuous, Discrete, SliderMotor

### Community 15 - "Camera CameraRuntimeController"
Cohesion: 0.10
Nodes (8): ArrowVertex, CameraBasis, HeadingMath, FloatArray, NavigationArrowMesh, ProjectedArrowPoint, Vector3, HeadingMathTest

### Community 16 - "Bluetooth BleSignal"
Cohesion: 0.12
Nodes (19): PermissionKind, Accessibility, Bluetooth, ForegroundService, Microphone, Notifications, Overlay, PermissionsState (+11 more)
...
Cohesion: 0.05
Nodes (37): ActivateModeRailEntry, AdjustOptionsItem, CameraCommand, CapturePhoto, DeleteVideoRecording, HighlightRecordingSaveLocation, NudgeSetting, OpenGallery (+29 more)

### Community 21 - "Core AppState"
Cohesion: 0.11
Nodes (7): PointingGesture, DiveViewModel, android, com, BleSignal, ByteArray, HousingLinkEvent
...
Cohesion: 0.12
Nodes (10): DiscoveredDevice, BleTransportOrchestrator, encodeLittleEndianU32(), Boolean, ByteArray, Int, Long, UByte (+2 more)
...
Cohesion: 0.12
Nodes (4): ImageCapture, ImageCaptureException, Result, UnderwaterFrameObservation
...
### Community 29 - "Camera CameraCatalogTest"
Cohesion: 0.16
Nodes (5): android, SensorColorCalibration, WbPipeline, DoubleArray, RggbChannelVector

### Community 32 - "Bluetooth HousingUuidResolverTest"
Cohesion: 0.13
Nodes (9): MainActivity, BlePermissions, Boolean, Context, List, String, BluetoothAdapter, Bundle (+1 more)

### Community 33 - "Safety SafetyStateMachine"
Cohesion: 0.20
Nodes (25): ContinuePill(), drawBanner(), drawCapComingOff(), drawCheckBadge(), drawDownAsk(), drawPermissions(), IntroCarousel, IntroCarouselScreen() (+17 more)

### Community 35 - "Tutorial ButtonTutorialScreen.kt"
Cohesion: 0.19
Nodes (3): Reduction, RouteDecision, SafetyMachineResult

### Community 37 - "Core Reduction"
Cohesion: 0.25
Nodes (7): Boolean, Double, List, Long, String, SafetyMachineResult, SafetyStateMachine

### Community 38 - "Core GalleryCommand"
Cohesion: 0.13
Nodes (6): CameraEffect, androidx, RecorderVideoCapabilities, FocusPeakingSurfaceProcessor, PointingGestureRecognizer, Size
...
Cohesion: 0.12
Nodes (10): BleConnectionParams, BleTransport, Boolean, ByteArray, Long, Set, String, NotificationListener (+2 more)
...
Cohesion: 0.13
Nodes (10): BackCameraProfile, IntRange, ManualFocusTransport, Fixed, Hybrid, PublicDiopter, SamsungLensPosition, PhysicalLensProfile (+2 more)
...
Cohesion: 0.15
Nodes (18): Modifier, ModeIndicator(), DiveControlContent(), DiveControlScreen(), androidx, com, CompassReading, Modifier (+10 more)

### Community 45 - "Color DiveColors"
Cohesion: 0.26
Nodes (19): accented(), CenteredSealBanner(), formatRemaining(), Color, Modifier, passedLabel(), pressureDropKpa(), SealBanner() (+11 more)
...
Cohesion: 0.11
Nodes (18): CreateGalleryFolder, DeleteGalleryAlbum, DeleteGalleryFolder, DeleteGalleryItem, EmitAlert, ExecuteCamera, ExecuteHousing, ExecutePhoneControl (+10 more)
...
Cohesion: 0.21
Nodes (3): ManualFocusRequest, CaptureRequest, T

### Community 53 - "App DiveViewModel.kt"
Cohesion: 0.18
Nodes (9): cardinal(), DepthGauge(), depthMetersFromPressure(), formatHeading(), headingReadoutColor(), Modifier, ReadoutSeparator(), VacuumReadout (+1 more)

### Community 54 - "Core HousingCommand"
Cohesion: 0.12
Nodes (11): AndroidViewModel, HeadingStore, StateFlow, SealConfidence, Conservative, ManufacturerMinimum, Monitoring, Provisional (+3 more)

### Community 55 - "Tutorial HousingDiagram"
Cohesion: 0.14
Nodes (13): CameraPreview(), LifecycleOwner, Modifier, Double, Long, Modifier, VacuumTimerIndicator(), HousingDiagram() (+5 more)
...
Cohesion: 0.33
Nodes (14): arrowHead(), brightened(), drawButton(), drawFrame(), drawPlate(), drawSlider(), HousingControl, Color (+6 more)

### Community 58 - "App CaptureRequest"
Cohesion: 0.14
Nodes (3): UnderwaterFrameAnalyzerTest, Get-AdbDeviceLines(), Resolve-TargetSerial()

### Community 59 - "Camera .bindCamera"
Cohesion: 0.16
...
Cohesion: 0.30
Nodes (10): CameraHudOverlay(), formatTimestamp(), CompassReading, Modifier, OverlayPill(), rememberClockText(), TargetHeadingArrow(), ConnectionStatus() (+2 more)

### Community 66 - "Core ButtonEventNormalizer"
Cohesion: 0.21
Nodes (7): cameraReadoutBottomPadding(), CameraHudOverlayLayoutTest, CameraUiZone, LiveView, ModeRail, SettingsPanel, Dp
...
Cohesion: 0.21
Nodes (5): GalleryConsentRequest, GalleryMediaManagementRequest, Result, Ramp, kotlinx
...
Cohesion: 0.31
Nodes (6): CompassHeadingMonitor, CompassReading, StateFlow, Sensor, SensorEvent, SensorEventListener

### Community 73 - "Core SafetyCommand"
Cohesion: 0.24
Nodes (4): IntArray, MaximumInformationRequestModes, VideoDynamicRangePolicy, DynamicRange

### Community 74 - "Core ControlCommand"
Cohesion: 0.27
Nodes (11): fitPlateText(), glowAnnotated(), AnnotatedString, Int, List, String, TextStyle, TextUnit (+3 more)
...
### Community 83 - "Tests ProtocolParserTest"
Cohesion: 0.20
...
### Community 90 - "Tests SamsungLogProfileTest"
Cohesion: 0.22
...
### Community 93 - "Camera VideoDynamicRangePolicyTest"
Cohesion: 0.29
...
Cohesion: 0.57
Nodes (6): DiagnosticsActionTile(), DiagnosticsScreen(), InfoCard(), InfoRow(), Modifier, SectionHeader()
...
Cohesion: 0.33
Nodes (6): CompassAccuracy, High, Low, Medium, Unavailable, Unreliable

### Community 108 - "Camera cameraReadoutBottomPadding"
Cohesion: 0.73
...
Cohesion: 0.53
Nodes (5): com, LifecycleOwner, Modifier, StateDrivenCameraPreview(), PreviewView
...
### Community 113 - "Tests HousingCommandEncoderTest"
Cohesion: 0.40
...
Cohesion: 0.40
Nodes (4): dwellFor(), Int, Long, IntroFrame
...
### Community 124 - "App run-gradle.ps1"
Cohesion: 0.67
...
## Knowledge Gaps
- **366 isolated node(s):** `ArrowVertex`, `Kind`, `HousingService`, `BleConnectionParams`, `High` (+361 more)
...
- **Why does `AppState` connect `App WFH07 Bluetooth Communication Protocol` to `Gallery GalleryRepository`, `Underwater UnderwaterWhiteBalanceEstimator`, `Tests ControlCoreTest`, `Camera PointingGestureRecognizer.kt`, `Camera FocusPeakingSurfaceProcessor`, `Bluetooth HousingLink`, `Bluetooth BleSignal`, `Core AppState`, `Camera .wbPipeline`, `Tutorial ButtonTutorialScreen.kt`, `Tutorial HousingDiagram.kt`, `Diagnostics .add`, `Camera .detectDeviceCapabilitiesViaCameraManager`, `Heading HeadingMath`, `Core HousingCommand`, `Tests test.ps1`, `App Customer Trust Contract`, `Safety SafetyStateMachine.kt`, `Camera VideoDynamicRangePolicyTest`, `Core .reducePhoneControl`, `Tests AutofocusHoldPolicyTest`, `Diagnostics DiagnosticsScreen`, `Core .activateMode`?**
  _High betweenness centrality (0.147) - this node is a cross-community bridge._
- **Why does `CameraRuntimeController` connect `Bluetooth AndroidBleTransport` to `Core GalleryCommand`, `Tests ControlCoreTest`, `Bluetooth GattOutcome`, `Tutorial IntroFrame`, `Heading HeadingMathTest`, `Core .decodeNotification`, `Core PhoneControlCommand`, `Core CameraCommand`, `Core PlatformEffect`, `Camera CameraCatalogTest`, `Tests .readyState`?**
  _High betweenness centrality (0.079) - this node is a cross-community bridge._
- **Why does `SafetyState` connect `Core ControlReducer` to `Camera CameraShellScreen.kt`, `Core GalleryPreviewAction`, `Core Reduction`, `Camera PointingGestureRecognizer.kt`, `Heading HeadingMath`, `Color DiveColors`, `Tutorial IntroFrame`, `Bluetooth HousingStore`, `App DiveViewModel.kt`, `Camera .wbPipeline`?**
